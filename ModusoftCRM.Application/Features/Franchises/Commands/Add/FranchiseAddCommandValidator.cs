...
{
    public class FranchiseAddCommandValidator : AbstractValidator<FranchiseAddCommand>
    {
        public FranchiseAddCommandValidator()
        {
            RuleFor(x => x.Name)
                .NotEmpty().WithMessage("Franchise adı boş geçilemez.")
